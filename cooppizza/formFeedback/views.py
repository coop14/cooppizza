...
from cooppizza.formFeedback.forms import FeedbackForm
...
def formularioFeedback(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			email = form.cleaned_data.get('email', 'from@example.com')
			send_mail('SUBJECT', 'message', 'from@example.com', ['ultimos.jn@gmail.com'], fail_silently=False)
